function out = imoverlay_2mask(in, mask1, color1, mask2, color2)
...
if strcmp(color1, 'rosso')
    color1 = [1 0 0];
end

if strcmp(color1, 'blu')
    color1 = [0 0 1];
end

if strcmp(color1, 'verde')
    color1 = [0 1 0];
end
...
if strcmp(color2, 'rosso')
    color2 = [1 0 0];
end

if strcmp(color2, 'blu')
    color2 = [0 0 1];
end

if strcmp(color2, 'verde')
    color2 = [0 1 0];
end
...
color1_uint8 = im2uint8(color1);
color2_uint8 = im2uint8(color2);
...
% color value.
out_red(mask1)   = color1_uint8(1);
out_green(mask1) = color1_uint8(2);
out_blue(mask1)  = color1_uint8(3);


out_red(mask2)   = color2_uint8(1);
out_green(mask2) = color2_uint8(2);
out_blue(mask2)  = color2_uint8(3);
